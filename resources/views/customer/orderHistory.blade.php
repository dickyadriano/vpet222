            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        ...
                        <a href="{{ route('orderHistory') }}" class="btn btn-sm btn-neutral active">Order History</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="header-body">
            ...
            <div class="row">
                ...
                @foreach($vaccine_data as $row)
                                ...
                                <div class="row" style="justify-content: right">
                                    <div class="col-auto">
                                        @if($row->orderStatus == 'Completed')
                                            <button type="button" class="btn btn-facebook mr-3" data-toggle="modal" data-target="#reviewVaccine">Review Service</button>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    {{-- Modal Review Vaccine --}}
                    <div class="modal fade" id="reviewVaccine" tabindex="-1" role="dialog" aria-labelledby="reviewVaccineTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form action="{{ route('review.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <input type="number" name="userID" value="{{ Auth::user()->id }}" hidden>
                                        <input type="number" name="vaccineID" value="{{ $row->vaccineID }}" hidden>
                                        <input type="text" name="orderType" value="{{ $row->orderType }}" hidden>
                                        <div class="form-group">
                                            <label for="rate">Rate</label>
                                            <select name="rate" class="form-control" id="rate">
