            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        ...
                        <a href="{{route('petCare.index')}}" class="btn btn-sm btn-neutral active">Animal Care</a>
                ...
                <div class="col-xl-3 col-lg-4 pb-3">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <img class="img-center img-thumbnail" src="{{ asset('img/careImages/'. $row->image) }}" style="width: 240px; height: 240px">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col">
                                        <img class="img-center img-thumbnail" src="{{ asset('img/careImages/'. $row->image) }}" style="width: 200px; height: 200px">
                                    </div>
                                    <div class="col">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-target="#detailPetCare<?php echo $count; ?>">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="text" name="orderType" value="petCare" hidden readonly>
